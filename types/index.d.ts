...
declare namespace PhonegapPluginPushapePush {
	interface PushAndroidInitOptions {
		/**
		 * The name of a drawable resource to use as the small-icon. The name should not include the extension.
		 */
		icon?: string;
	...
	interface InitPushapeOptions extends PhonegapPluginPush.InitOptions {
		enabled?: boolean;
	...
	interface PushapeEventRegistrationData extends PhonegapPluginPush.RegistrationEventResponse {
		push_id: string;
		status: number;
	}

	interface PushapeNotificationStatic extends PhonegapPluginPush.PushNotificationStatic {
		init(options: InitPushapeOptions): PhonegapPluginPush.PushNotification
		new (options: InitPushapeOptions): PhonegapPluginPush.PushNotification
	}
}
